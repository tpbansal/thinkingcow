...
/* Entry Metadata Styles (role/issuer + date + location lines) */
.content h3 + p,
.content h4 + p {
...
I served as the **Incident Response Lead (ICL)** for ClickHouse Cloud, where I oversaw the entire cycle for production incident handling and resolution. I implemented and shared ownership for key infrastructure initiatives such as public cloud platform management (AWS, GCP, and Azure landing zones), internal access systems (Auth*), zero trust networking / BeyondCorp (Tailscale), Enterprise Security Tooling (Kandji, SentinelOne, Okta), business, support services (cloud billing, Slack & Google Workspaces Administration), and other engineering (CMS, etc.) system improvements 
...
### Nebius AI CloudOps Engineer Certification
**Nebius Academy** | *Issued July 2026* | [View Badge](https://www.credly.com/badges/44d91699-d14f-4519-a442-3daad7ca827c)
